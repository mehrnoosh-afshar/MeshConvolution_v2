...
class Model(nn.Module):
    ...
    def init_layers(self, batch):
        ...
        for l in range(self.layer_num):
            ...
            layer = (in_channel, out_channel, in_point_num, out_point_num, weight_num, max_neighbor_num, neighbor_num_lst,neighbor_id_lstlst, conv_layer, residual_layer, residual_rate, neighbor_mask_lst, zeros_batch_outpn_outchannel,conv_method)
    ...
    def forward_one_conv_layer_batch(self, in_pc, layer_info, is_final_layer=False):
        ...
        in_channel, out_channel, in_pn, out_pn, weight_num,  max_neighbor_num, neighbor_num_lst,neighbor_id_lstlst, conv_layer, residual_layer, residual_rate,neighbor_mask_lst, zeros_batch_outpn_outchannel, conv_method =layer_info
